...
| 快捷键 | 功能描述           | 对应命令       |
|--------+--------------------+----------------|
| C-c l  | 存储org链接        | org-store-link |
| C-c a  | 打开org议程        | org-agenda     |
| C-c c  | 快速捕获笔记       | org-capture    |
| C-c b  | 切换org缓冲区      | org-switchb    |
| M-g c  | 跳转到字符         | avy-goto-char  |
| M-g C  | 跳转到两个字符组合 | avy-goto-char-2|
| M-g w  | 跳转到单词         | avy-goto-word-1|
| M-g l  | 跳转到行           | avy-goto-line  |
